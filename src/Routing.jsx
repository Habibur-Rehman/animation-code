...
import { accordionIconURL, archinzaURL, homeURL, mapURL, playlistURL, printerURL, printerV2URL, rangoonBottleURL, rangoonHoverURL, rangoonURL, reactPlayerURL, silverPointURL, videoDemoURL } from "./helpers/paths";
